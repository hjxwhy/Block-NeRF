...
def get_opts_base():
    ...
    parser.add_argument('--deg_view', type=int)
    parser.add_argument('--use_exposure', type=bool, default=True,)
    parser.add_argument('--use_appearance', type=bool, default=True,)
    parser.add_argument('--deg_exposure', type=int)
    ...
    parser.add_argument('--lr_final', type=float, default=5e-4, help='learning rate')
    parser.add_argument('--lr_delay_steps', type=int, default=2500, help='learning rate')
    parser.add_argument('--lr_decay_factor', type=float, default=0.01, help='learning rate decay factor')

    parser.add_argument('--no_visibility', dest='visibility', default=True, action='store_false',
